...
<body>
  ...
  <section class="container">
    ...
    <div>
      <div class="alert alert-success alert-dismissible fade show alert-send d-none" role="alert">
        <strong>Feedback Berhasil Dikirim!</strong> Terima kasih!
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
      <form name="feedback-form">
        <input name="feedback" class="form-control feed" type="text" placeholder="Type Your Feedback in Here" minlength="1">
  ...
  <script>
    ...
    const feedForm = document.forms["feedback-form"]["feedback"].value;
